    ...
    return (
      <div className="todo todo-list">
        <button
          ...
          onClick={() =>
            onUpdate({ ...todo, completionStatus: !todo.completionStatus })
          }
        >
          <FontAwesomeIcon
            icon={helper.getIconForCompletion(todo.completionStatus)}
            size={helper.getIconSizeBasedOnScreenSize()}
          />
        </button>
        <label
          hidden={todo.isEditing}
          style={{
            textDecoration: todo.completionStatus ? "line-through" : "none",
            height: "auto"
          }}
        ...
        <input
          ...
          onBlur={e =>
            onUpdate({ ...todo, text: e.target.value, isEditing: false })
          }
          style={{
            textDecoration: todo.completionStatus ? "line-through" : "none",
            marginBottom: 8
        ...
        <button
          onClick={() =>
            this.props.onUpdate({ ...this.props.todo, isEditing: true })
          }
